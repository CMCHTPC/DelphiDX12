...
{ **************************************************************************
  Copyright (C) 2015-2020 CMC Development Team

  CMC (Compact Media Center) is free software: you can redistribute it and/or modify
...
{ **************************************************************************
  ...
  DirectX Header Version 10.0.19041.0

  Copyright (c) Microsoft Corporation.  All rights reserved.

  This unit consists of the following header files
  File name: D3D11SDKLayers.h
...
const
    ...
    D3D11_REGKEY_PATH: WideString = 'Software\\Microsoft\\Direct3D';
    D3D11_MUTE_DEBUG_OUTPUT: WideString = 'MuteDebugOutput';
    D3D11_ENABLE_BREAK_ON_MESSAGE: WideString = 'EnableBreakOnMessage';
    D3D11_INFOQUEUE_STORAGE_FILTER_OVERRIDE: WideString = 'InfoQueueStorageFilterOverride';
    D3D11_MUTE_CATEGORY: WideString = 'Mute_CATEGORY_%s';
    D3D11_MUTE_SEVERITY: WideString = 'Mute_SEVERITY_%s';
    D3D11_MUTE_ID_STRING: WideString = 'Mute_ID_%s';
    D3D11_MUTE_ID_DECIMAL: WideString = 'Mute_ID_%d';
    D3D11_UNMUTE_SEVERITY_INFO: WideString = 'Unmute_SEVERITY_INFO';
    D3D11_BREAKON_CATEGORY: WideString = 'BreakOn_CATEGORY_%s';
    D3D11_BREAKON_SEVERITY: WideString = 'BreakOn_SEVERITY_%s';
    D3D11_BREAKON_ID_STRING: WideString = 'BreakOn_ID_%s';
    D3D11_BREAKON_ID_DECIMAL: WideString = 'BreakOn_ID_%d';
    D3D11_APPSIZE_STRING: WideString = 'Size';
    D3D11_APPNAME_STRING: WideString = 'Name';
    D3D11_FORCE_DEBUGGABLE: WideString = 'ForceDebuggable';
    D3D11_FORCE_SHADER_SKIP_OPTIMIZATION: WideString = 'ForceShaderSkipOptimization';
...
type
    ...
    TD3D11_SHADER_TRACKING_OPTION = (
        ...
        Ord(D3D11_SHADER_TRACKING_OPTION_TRACK_RAW_ACROSS_THREADGROUPS) or Ord(D3D11_SHADER_TRACKING_OPTION_TRACK_WAR_ACROSS_THREADGROUPS) or
        Ord(D3D11_SHADER_TRACKING_OPTION_TRACK_WAW_ACROSS_THREADGROUPS) or Ord(
        D3D11_SHADER_TRACKING_OPTION_TRACK_ATOMIC_CONSISTENCY_ACROSS_THREADGROUPS),
        D3D11_SHADER_TRACKING_OPTION_ALL_HAZARDS =
        Ord(D3D11_SHADER_TRACKING_OPTION_TRACK_RAW) or Ord(D3D11_SHADER_TRACKING_OPTION_TRACK_WAR) or Ord(
        D3D11_SHADER_TRACKING_OPTION_TRACK_WAW) or Ord(D3D11_SHADER_TRACKING_OPTION_TRACK_ATOMIC_CONSISTENCY) or
        Ord(D3D11_SHADER_TRACKING_OPTION_TRACK_RAW_ACROSS_THREADGROUPS) or Ord(D3D11_SHADER_TRACKING_OPTION_TRACK_WAR_ACROSS_THREADGROUPS) or
        Ord(D3D11_SHADER_TRACKING_OPTION_TRACK_WAW_ACROSS_THREADGROUPS) or
    ...
    TD3D11_MESSAGE_ID = (
        ...
        (D3D11_MESSAGE_ID_NEGOTIATECRYPTOSESSIONKEYEXCHANGEMT_INVALIDKEYEXCHANGETYPE + 1),
        D3D11_MESSAGE_ID_DECODERBEGINFRAME_INVALID_HISTOGRAM_COMPONENT_COUNT =
        (D3D11_MESSAGE_ID_NEGOTIATECRYPTOSESSIONKEYEXCHANGEMT_NOT_SUPPORTED + 1),
        D3D11_MESSAGE_ID_DECODERBEGINFRAME_INVALID_HISTOGRAM_COMPONENT =
        (D3D11_MESSAGE_ID_DECODERBEGINFRAME_INVALID_HISTOGRAM_COMPONENT_COUNT + 1),
        ...
        (D3D11_MESSAGE_ID_DECODERBEGINFRAME_INVALID_HISTOGRAM_BUFFER_SIZE + 1),
        D3D11_MESSAGE_ID_DECODERBEGINFRAME_INVALID_HISTOGRAM_BUFFER_MISC_FLAGS =
        (D3D11_MESSAGE_ID_DECODERBEGINFRAME_INVALID_HISTOGRAM_BUFFER_USAGE + 1),
        D3D11_MESSAGE_ID_DECODERBEGINFRAME_INVALID_HISTOGRAM_BUFFER_OFFSET =
        (D3D11_MESSAGE_ID_DECODERBEGINFRAME_INVALID_HISTOGRAM_BUFFER_MISC_FLAGS + 1),
    ...
    TD3D11_MESSAGE = record
        ...
        pDescription {DescriptionByteLength}: PAnsiChar;
    ...
    TD3D11_INFO_QUEUE_FILTER_DESC = record
        NumCategories: UINT;
        pCategoryList {NumCategories}: PD3D11_MESSAGE_CATEGORY;
        NumSeverities: UINT;
        pSeverityList {NumSeverities}: PD3D11_MESSAGE_SEVERITY;
        NumIDs: UINT;
        pIDList {NumIDs}: PD3D11_MESSAGE_ID;
    end;
    ...
    ID3D11InfoQueue = interface(IUnknown)
        ...
        function GetMessage(MessageIndex: UINT64; out pMessage {pMessageByteLength}: PD3D11_MESSAGE;
        ...
        function GetStorageFilter(out pFilter {pFilterByteLength}: PD3D11_INFO_QUEUE_FILTER;
        ...
        function GetRetrievalFilter(out pFilter {pFilterByteLength}: PD3D11_INFO_QUEUE_FILTER;
            var pFilterByteLength: SIZE_T): HResult; stdcall;
        ...
        function AddApplicationMessage(Severity: TD3D11_MESSAGE_SEVERITY; pDescription: LPCSTR): HResult; stdcall;
        function SetBreakOnCategory(Category: TD3D11_MESSAGE_CATEGORY; bEnable: boolean): HResult; stdcall;
        function SetBreakOnSeverity(Severity: TD3D11_MESSAGE_SEVERITY; bEnable: boolean): HResult; stdcall;
        function SetBreakOnID(ID: TD3D11_MESSAGE_ID; bEnable: boolean): HResult; stdcall;
        function GetBreakOnCategory(Category: TD3D11_MESSAGE_CATEGORY): boolean; stdcall;
        function GetBreakOnSeverity(Severity: TD3D11_MESSAGE_SEVERITY): boolean; stdcall;
        function GetBreakOnID(ID: TD3D11_MESSAGE_ID): boolean; stdcall;
