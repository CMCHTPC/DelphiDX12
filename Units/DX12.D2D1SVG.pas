...
type
    ...
    ID2D1SvgElement = interface(ID2D1Resource)
        ...
        function CreateChild(tagName: PCWSTR; out newChild: ID2D1SvgElement): HResult; stdcall;
        function IsAttributeSpecified(Name: PCWSTR; out AInherited: boolean): boolean; stdcall;
        ...
        function SetAttributeValue(Name: PCWSTR; AType: TD2D1_SVG_ATTRIBUTE_STRING_TYPE; Value: PCWSTR): HResult;
            stdcall; overload;
