...
type
    ...
    ID3D11RefTrackingOptions = interface;
    ...
    PD3D11_RLDO_FLAGS = ^TD3D11_RLDO_FLAGS;
    ...
    ID3D11Debug = interface(IUnknown)
        ...
        {_In_  } pContext: ID3D11DeviceContext): HRESULT; stdcall;
    ...
    PD3D11_SHADER_TRACKING_RESOURCE_TYPE = ^TD3D11_SHADER_TRACKING_RESOURCE_TYPE;
    ...
    TD3D11_SHADER_TRACKING_OPTION = (
        ...
        Ord(D3D11_SHADER_TRACKING_OPTION_TRACK_RAW_ACROSS_THREADGROUPS) or Ord(D3D11_SHADER_TRACKING_OPTION_TRACK_WAR_ACROSS_THREADGROUPS) or Ord(D3D11_SHADER_TRACKING_OPTION_TRACK_WAW_ACROSS_THREADGROUPS) or
        Ord(D3D11_SHADER_TRACKING_OPTION_TRACK_ATOMIC_CONSISTENCY_ACROSS_THREADGROUPS),
        D3D11_SHADER_TRACKING_OPTION_ALL_HAZARDS =
        Ord(D3D11_SHADER_TRACKING_OPTION_TRACK_RAW) or Ord(D3D11_SHADER_TRACKING_OPTION_TRACK_WAR) or Ord(D3D11_SHADER_TRACKING_OPTION_TRACK_WAW) or Ord(D3D11_SHADER_TRACKING_OPTION_TRACK_ATOMIC_CONSISTENCY) or
        Ord(D3D11_SHADER_TRACKING_OPTION_TRACK_RAW_ACROSS_THREADGROUPS) or Ord(D3D11_SHADER_TRACKING_OPTION_TRACK_WAR_ACROSS_THREADGROUPS) or Ord(D3D11_SHADER_TRACKING_OPTION_TRACK_WAW_ACROSS_THREADGROUPS) or
        Ord(D3D11_SHADER_TRACKING_OPTION_TRACK_ATOMIC_CONSISTENCY_ACROSS_THREADGROUPS),
    ...
    PD3D11_SHADER_TRACKING_OPTION = ^TD3D11_SHADER_TRACKING_OPTION;

    TD3D11_SHADER_TRACKING_OPTIONS = TD3D11_SHADER_TRACKING_OPTION;


    ID3D11TracingDevice = interface(IUnknown)
        ['{1911c771-1587-413e-a7e0-fb26c3de0268}']
        function SetShaderTrackingOptionsByType(
        {_In_  } ResourceTypeFlags: UINT;
        {_In_  } Options: UINT): HRESULT; stdcall;

        function SetShaderTrackingOptions(
    ...
    TD3D11_MESSAGE = record
        ...
        ID: TD3D11_MESSAGE_ID; (* [annotation] *)
    ...
    TD3D11_INFO_QUEUE_FILTER_DESC = record
        ...
        {_Field_size_(NumCategories)  } pCategoryList: PD3D11_MESSAGE_CATEGORY;
        NumSeverities: UINT; (* [annotation] *)
        {_Field_size_(NumSeverities)  } pSeverityList: PD3D11_MESSAGE_SEVERITY;
        NumIDs: UINT; (* [annotation] *)
        {_Field_size_(NumIDs)  } pIDList: PD3D11_MESSAGE_ID;
    end;
    ...
    ID3D11InfoQueue = interface(IUnknown)
        ...
        {_Out_writes_bytes_opt_(*pMessageByteLength)  } pMessage: PD3D11_MESSAGE;
        ...
        {_In_  } pFilter: PD3D11_INFO_QUEUE_FILTER): HRESULT; stdcall;
        ...
        function AddMessage(
        {_In_  } Category: TD3D11_MESSAGE_CATEGORY;
        {_In_  } Severity: TD3D11_MESSAGE_SEVERITY;
        {_In_  } ID: TD3D11_MESSAGE_ID;
        ...
        {_In_  } Category: TD3D11_MESSAGE_CATEGORY): boolean; stdcall;

        function GetBreakOnSeverity(
        {_In_  } Severity: TD3D11_MESSAGE_SEVERITY): boolean; stdcall;

        function GetBreakOnID(
        {_In_  } ID: TD3D11_MESSAGE_ID): boolean; stdcall;
