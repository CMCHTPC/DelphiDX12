...
type
    ...
    end {$IFDEF WIN64} align(16){$ENDIF};
    ...
    TD3DX_CPU_OPTIMIZATION = _D3DX_CPU_OPTIMIZATION;
    PD3DX_CPU_OPTIMIZATION = ^TD3DX_CPU_OPTIMIZATION;
...
function D3DXFloat32To16Array(
    {_In_} pOut: PD3DXFLOAT16;
    {_In_} pIn: Psingle;
    {_In_} n: UINT): TD3DXFLOAT16; stdcall; external D3DX10_DLL;


// Converts an array 16-bit floats to 32-bit floats
function D3DXFloat16To32Array(
    {__out_ecount(n)} pOut: Psingle;
    { __in_ecount(n)} pIn: PD3DXFLOAT16;
    {_In_} n: UINT): single; stdcall; external D3DX10_DLL;
...
function D3DXVec2Normalize(pOut: PD3DXVECTOR2; pV: PD3DXVECTOR2): TD3DXVECTOR2; stdcall; external D3DX10_DLL;


// Hermite interpolation between position V1, tangent T1 (when s == 0)
// and position V2, tangent T2 (when s == 1).
function D3DXVec2Hermite(pOut: PD3DXVECTOR2; pV1: PD3DXVECTOR2; pT1: PD3DXVECTOR2; pV2: PD3DXVECTOR2; pT2: PD3DXVECTOR2; s: single): TD3DXVECTOR2; stdcall; external D3DX10_DLL;


// CatmullRom interpolation between V1 (when s == 0) and V2 (when s == 1)
function D3DXVec2CatmullRom(pOut: PD3DXVECTOR2; pV0: PD3DXVECTOR2; pV1: PD3DXVECTOR2; pV2: PD3DXVECTOR2; pV3: PD3DXVECTOR2; s: single): TD3DXVECTOR2; stdcall; external D3DX10_DLL;


// Barycentric coordinates.  V1 + f(V2-V1) + g(V3-V1)
function D3DXVec2BaryCentric(pOut: PD3DXVECTOR2; pV1: PD3DXVECTOR2; pV2: PD3DXVECTOR2; pV3: PD3DXVECTOR2; f: single; g: single): TD3DXVECTOR2; stdcall; external D3DX10_DLL;


// Transform (x, y, 0, 1) by matrix.
function D3DXVec2Transform(pOut: PD3DXVECTOR4; pV: PD3DXVECTOR2; pM: PD3DXMATRIX): TD3DXVECTOR4; stdcall; external D3DX10_DLL;


// Transform (x, y, 0, 1) by matrix, project result back into w=1.
function D3DXVec2TransformCoord(pOut: PD3DXVECTOR2; pV: PD3DXVECTOR2; pM: PD3DXMATRIX): TD3DXVECTOR2; stdcall; external D3DX10_DLL;


// Transform (x, y, 0, 0) by matrix.
function D3DXVec2TransformNormal(pOut: PD3DXVECTOR2; pV: PD3DXVECTOR2; pM: PD3DXMATRIX): TD3DXVECTOR2; stdcall; external D3DX10_DLL;


// Transform Array (x, y, 0, 1) by matrix.
function D3DXVec2TransformArray(pOut: PD3DXVECTOR4; OutStride: UINT; pV: PD3DXVECTOR2; VStride: UINT; pM: PD3DXMATRIX; n: UINT): TD3DXVECTOR4; stdcall; external D3DX10_DLL;


// Transform Array (x, y, 0, 1) by matrix, project result back into w=1.
function D3DXVec2TransformCoordArray(pOut: PD3DXVECTOR2; OutStride: UINT; pV: PD3DXVECTOR2; VStride: UINT; pM: PD3DXMATRIX; n: UINT): TD3DXVECTOR2; stdcall; external D3DX10_DLL;


// Transform Array (x, y, 0, 0) by matrix.
function D3DXVec2TransformNormalArray(pOut: PD3DXVECTOR2; OutStride: UINT; pV: PD3DXVECTOR2; VStride: UINT; pM: PD3DXMATRIX; n: UINT): TD3DXVECTOR2; stdcall; external D3DX10_DLL;
...
function D3DXVec3Normalize(pOut: PD3DXVECTOR3; pV: PD3DXVECTOR3): TD3DXVECTOR3; stdcall; external D3DX10_DLL;


// Hermite interpolation between position V1, tangent T1 (when s == 0)
// and position V2, tangent T2 (when s == 1).
function D3DXVec3Hermite(pOut: PD3DXVECTOR3; pV1: PD3DXVECTOR3; pT1: PD3DXVECTOR3; pV2: PD3DXVECTOR3; pT2: PD3DXVECTOR3; s: single): TD3DXVECTOR3; stdcall; external D3DX10_DLL;


// CatmullRom interpolation between V1 (when s == 0) and V2 (when s == 1)
function D3DXVec3CatmullRom(pOut: PD3DXVECTOR3; pV0: PD3DXVECTOR3; pV1: PD3DXVECTOR3; pV2: PD3DXVECTOR3; pV3: PD3DXVECTOR3; s: single): PD3DXVECTOR3; stdcall; external D3DX10_DLL;


// Barycentric coordinates.  V1 + f(V2-V1) + g(V3-V1)
function D3DXVec3BaryCentric(pOut: PD3DXVECTOR3; pV1: PD3DXVECTOR3; pV2: PD3DXVECTOR3; pV3: PD3DXVECTOR3; f: single; g: single): PD3DXVECTOR3; stdcall; external D3DX10_DLL;


// Transform (x, y, z, 1) by matrix.
function D3DXVec3Transform(pOut: PD3DXVECTOR4; pV: PD3DXVECTOR3; pM: PD3DXMATRIX): PD3DXVECTOR4; stdcall; external D3DX10_DLL;


// Transform (x, y, z, 1) by matrix, project result back into w=1.
function D3DXVec3TransformCoord(pOut: PD3DXVECTOR3; pV: PD3DXVECTOR3; pM: PD3DXMATRIX): PD3DXVECTOR3; stdcall; external D3DX10_DLL;
...
function D3DXVec3TransformNormal(pOut: PD3DXVECTOR3; pV: PD3DXVECTOR3; pM: PD3DXMATRIX): PD3DXVECTOR3; stdcall; external D3DX10_DLL;


// Transform Array (x, y, z, 1) by matrix.
function D3DXVec3TransformArray(pOut: PD3DXVECTOR4; OutStride: UINT; pV: PD3DXVECTOR3; VStride: UINT; pM: PD3DXMATRIX; n: UINT): TD3DXVECTOR4; stdcall; external D3DX10_DLL;


// Transform Array (x, y, z, 1) by matrix, project result back into w=1.
function D3DXVec3TransformCoordArray(pOut: PD3DXVECTOR3; OutStride: UINT; pV: PD3DXVECTOR3; VStride: UINT; pM: PD3DXMATRIX; n: UINT): TD3DXVECTOR3; stdcall; external D3DX10_DLL;


// Transform (x, y, z, 0) by matrix.  If you transforming a normal by a
// non-affine matrix, the matrix you pass to this function should be the
// transpose of the inverse of the matrix you would use to transform a coord.
function D3DXVec3TransformNormalArray(pOut: PD3DXVECTOR3; OutStride: UINT; pV: PD3DXVECTOR3; VStride: UINT; pM: PD3DXMATRIX; n: UINT): TD3DXVECTOR3; stdcall; external D3DX10_DLL;


// Project vector from object space into screen space
function D3DXVec3Project(pOut: PD3DXVECTOR3; pV: PD3DXVECTOR3; pViewport: PD3D10_VIEWPORT; pProjection: PD3DXMATRIX; pView: PD3DXMATRIX; pWorld: PD3DXMATRIX): TD3DXVECTOR3; stdcall; external D3DX10_DLL;


// Project vector from screen space into object space
function D3DXVec3Unproject(pOut: PD3DXVECTOR3; pV: PD3DXVECTOR3; pViewport: PD3D10_VIEWPORT; pProjection: PD3DXMATRIX; pView: PD3DXMATRIX; pWorld: PD3DXMATRIX): TD3DXVECTOR3; stdcall; external D3DX10_DLL;


// Project vector Array from object space into screen space
function D3DXVec3ProjectArray(pOut: PD3DXVECTOR3; OutStride: UINT; pV: PD3DXVECTOR3; VStride: UINT; pViewport: PD3D10_VIEWPORT; pProjection: PD3DXMATRIX; pView: PD3DXMATRIX; pWorld: PD3DXMATRIX;
    n: UINT): TD3DXVECTOR3; stdcall; external D3DX10_DLL;


// Project vector Array from screen space into object space
function D3DXVec3UnprojectArray(pOut: PD3DXVECTOR3; OutStride: UINT; pV: PD3DXVECTOR3; VStride: UINT; pViewport: PD3D10_VIEWPORT; pProjection: PD3DXMATRIX; pView: PD3DXMATRIX; pWorld: PD3DXMATRIX; n: UINT): TD3DXVECTOR3;
    stdcall; external D3DX10_DLL;
...
function D3DXVec4Cross(pOut: PD3DXVECTOR4; pV1: PD3DXVECTOR4; pV2: PD3DXVECTOR4; pV3: PD3DXVECTOR4): TD3DXVECTOR4; stdcall; external D3DX10_DLL;


function D3DXVec4Normalize(pOut: PD3DXVECTOR4; pV: PD3DXVECTOR4): TD3DXVECTOR4; stdcall; external D3DX10_DLL;


// Hermite interpolation between position V1, tangent T1 (when s == 0)
// and position V2, tangent T2 (when s == 1).
function D3DXVec4Hermite(pOut: PD3DXVECTOR4; pV1: PD3DXVECTOR4; pT1: PD3DXVECTOR4; pV2: PD3DXVECTOR4; pT2: PD3DXVECTOR4; s: single): TD3DXVECTOR4; stdcall; external D3DX10_DLL;


// CatmullRom interpolation between V1 (when s == 0) and V2 (when s == 1)
function D3DXVec4CatmullRom(pOut: PD3DXVECTOR4; pV0: PD3DXVECTOR4; pV1: PD3DXVECTOR4; pV2: PD3DXVECTOR4; pV3: PD3DXVECTOR4; s: single): TD3DXVECTOR4; stdcall; external D3DX10_DLL;


// Barycentric coordinates.  V1 + f(V2-V1) + g(V3-V1)
function D3DXVec4BaryCentric(pOut: PD3DXVECTOR4; pV1: PD3DXVECTOR4; pV2: PD3DXVECTOR4; pV3: PD3DXVECTOR4; f: single; g: single): PD3DXVECTOR4; stdcall; external D3DX10_DLL;


// Transform vector by matrix.
function D3DXVec4Transform(pOut: PD3DXVECTOR4; pV: PD3DXVECTOR4; pM: PD3DXMATRIX): PD3DXVECTOR4; stdcall; overload; external D3DX10_DLL;


// Transform vector array by matrix.
function D3DXVec4TransformArray(pOut: PD3DXVECTOR4; OutStride: UINT; pV: PD3DXVECTOR4; VStride: UINT; pM: PD3DXMATRIX; n: UINT): TD3DXVECTOR4; stdcall; external D3DX10_DLL;
...
function D3DXMatrixDeterminant(pM: PD3DXMATRIX): single; stdcall; external D3DX10_DLL;


function D3DXMatrixDecompose(pOutScale: PD3DXVECTOR3; pOutRotation: PD3DXQUATERNION; pOutTranslation: PD3DXVECTOR3; pM: PD3DXMATRIX): HRESULT; stdcall; external D3DX10_DLL;


function D3DXMatrixTranspose(pOut: PD3DXMATRIX; pM: PD3DXMATRIX): PD3DXMATRIX; stdcall; external D3DX10_DLL;


// Matrix multiplication.  The result represents the transformation M2
// followed by the transformation M1.  (Out = M1 * M2)
function D3DXMatrixMultiply(pOut: PD3DXMATRIX; pM1: PD3DXMATRIX; pM2: PD3DXMATRIX): PD3DXMATRIX; stdcall; external D3DX10_DLL;


// Matrix multiplication, followed by a transpose. (Out = T(M1 * M2))
function D3DXMatrixMultiplyTranspose(pOut: PD3DXMATRIX; pM1: PD3DXMATRIX; pM2: PD3DXMATRIX): PD3DXMATRIX; stdcall; external D3DX10_DLL;


// Calculate inverse of matrix.  Inversion my fail, in which case NULL will
// be returned.  The determinant of pM is also returned it pfDeterminant
// is non-NULL.
function D3DXMatrixInverse(pOut: PD3DXMATRIX; pDeterminant: Psingle; pM: PD3DXMATRIX): PD3DXMATRIX; stdcall; external D3DX10_DLL;


// Build a matrix which scales by (sx, sy, sz)
function D3DXMatrixScaling(pOut: PD3DXMATRIX; sx: single; sy: single; sz: single): PD3DXMATRIX; stdcall; external D3DX10_DLL;


// Build a matrix which translates by (x, y, z)
function D3DXMatrixTranslation(pOut: PD3DXMATRIX; x: single; y: single; z: single): PD3DXMATRIX; stdcall; external D3DX10_DLL;


// Build a matrix which rotates around the X axis
function D3DXMatrixRotationX(pOut: PD3DXMATRIX; Angle: single): PD3DXMATRIX; stdcall; external D3DX10_DLL;


// Build a matrix which rotates around the Y axis
function D3DXMatrixRotationY(pOut: PD3DXMATRIX; Angle: single): PD3DXMATRIX; stdcall; external D3DX10_DLL;


// Build a matrix which rotates around the Z axis
function D3DXMatrixRotationZ(pOut: PD3DXMATRIX; Angle: single): PD3DXMATRIX; stdcall; external D3DX10_DLL;


// Build a matrix which rotates around an arbitrary axis
function D3DXMatrixRotationAxis(pOut: PD3DXMATRIX; pV: PD3DXVECTOR3; Angle: single): PD3DXMATRIX; stdcall; external D3DX10_DLL;


// Build a matrix from a quaternion
function D3DXMatrixRotationQuaternion(pOut: PD3DXMATRIX; pQ: PD3DXQUATERNION): PD3DXMATRIX; stdcall; external D3DX10_DLL;


// Yaw around the Y axis, a pitch around the X axis,
// and a roll around the Z axis.
function D3DXMatrixRotationYawPitchRoll(pOut: PD3DXMATRIX; Yaw: single; Pitch: single; Roll: single): PD3DXMATRIX; stdcall; overload; external D3DX10_DLL;
...
function D3DXMatrixTransformation(pOut: PD3DXMATRIX; pScalingCenter: PD3DXVECTOR3; pScalingRotation: PD3DXQUATERNION; pScaling: PD3DXVECTOR3; pRotationCenter: PD3DXVECTOR3; pRotation: PD3DXQUATERNION;
    pTranslation: PD3DXVECTOR3): PD3DXMATRIX; stdcall; external D3DX10_DLL;
...
function D3DXMatrixTransformation2D(pOut: PD3DXMATRIX; pScalingCenter: PD3DXVECTOR2; ScalingRotation: single; pScaling: PD3DXVECTOR2; pRotationCenter: PD3DXVECTOR2; Rotation: single;
    pTranslation: PD3DXVECTOR2): PD3DXMATRIX; stdcall; external D3DX10_DLL;


// Build affine transformation matrix.  NULL arguments are treated as identity.
// Mout = Ms * Mrc-1 * Mr * Mrc * Mt
function D3DXMatrixAffineTransformation(pOut: PD3DXMATRIX; Scaling: single; pRotationCenter: PD3DXVECTOR3; pRotation: PD3DXQUATERNION; pTranslation: PD3DXVECTOR3): PD3DXMATRIX; stdcall; external D3DX10_DLL;


// Build 2D affine transformation matrix in XY plane.  NULL arguments are treated as identity.
// Mout = Ms * Mrc-1 * Mr * Mrc * Mt
function D3DXMatrixAffineTransformation2D(pOut: PD3DXMATRIX; Scaling: single; pRotationCenter: PD3DXVECTOR2; Rotation: single; pTranslation: PD3DXVECTOR2): PD3DXMATRIX; stdcall; external D3DX10_DLL;


// Build a lookat matrix. (right-handed)
function D3DXMatrixLookAtRH(pOut: PD3DXMATRIX; pEye: PD3DXVECTOR3; pAt: PD3DXVECTOR3; pUp: PD3DXVECTOR3): PD3DXMATRIX; stdcall; external D3DX10_DLL;


// Build a lookat matrix. (left-handed)
function D3DXMatrixLookAtLH(pOut: PD3DXMATRIX; pEye: PD3DXVECTOR3; pAt: PD3DXVECTOR3; pUp: PD3DXVECTOR3): PD3DXMATRIX; stdcall;overload; external D3DX10_DLL;



// Build a perspective projection matrix. (right-handed)
function D3DXMatrixPerspectiveRH(pOut: PD3DXMATRIX; w: single; h: single; zn: single; zf: single): PD3DXMATRIX; stdcall; external D3DX10_DLL;


// Build a perspective projection matrix. (left-handed)
function D3DXMatrixPerspectiveLH(pOut: PD3DXMATRIX; w: single; h: single; zn: single; zf: single): PD3DXMATRIX; stdcall; external D3DX10_DLL;


// Build a perspective projection matrix. (right-handed)
function D3DXMatrixPerspectiveFovRH(pOut: PD3DXMATRIX; fovy: single; Aspect: single; zn: single; zf: single): PD3DXMATRIX; stdcall; external D3DX10_DLL;


// Build a perspective projection matrix. (left-handed)
function D3DXMatrixPerspectiveFovLH(pOut: PD3DXMATRIX; fovy: single; Aspect: single; zn: single; zf: single): PD3DXMATRIX; stdcall; external D3DX10_DLL;


// Build a perspective projection matrix. (right-handed)
function D3DXMatrixPerspectiveOffCenterRH(pOut: PD3DXMATRIX; l: single; r: single; b: single; t: single; zn: single; zf: single): PD3DXMATRIX; stdcall; external D3DX10_DLL;


// Build a perspective projection matrix. (left-handed)
function D3DXMatrixPerspectiveOffCenterLH(pOut: PD3DXMATRIX; l: single; r: single; b: single; t: single; zn: single; zf: single): PD3DXMATRIX; stdcall; external D3DX10_DLL;


// Build an ortho projection matrix. (right-handed)
function D3DXMatrixOrthoRH(pOut: PD3DXMATRIX; w: single; h: single; zn: single; zf: single): PD3DXMATRIX; stdcall; external D3DX10_DLL;


// Build an ortho projection matrix. (left-handed)
function D3DXMatrixOrthoLH(pOut: PD3DXMATRIX; w: single; h: single; zn: single; zf: single): PD3DXMATRIX; stdcall; external D3DX10_DLL;


// Build an ortho projection matrix. (right-handed)
function D3DXMatrixOrthoOffCenterRH(pOut: PD3DXMATRIX; l: single; r: single; b: single; t: single; zn: single; zf: single): PD3DXMATRIX; stdcall; external D3DX10_DLL;


// Build an ortho projection matrix. (left-handed)
function D3DXMatrixOrthoOffCenterLH(pOut: PD3DXMATRIX; l: single; r: single; b: single; t: single; zn: single; zf: single): PD3DXMATRIX; stdcall; external D3DX10_DLL;


// Build a matrix which flattens geometry into a plane, as if casting
// a shadow from a light.
function D3DXMatrixShadow(pOut: PD3DXMATRIX; pLight: PD3DXVECTOR4; pPlane: PD3DXPLANE): PD3DXMATRIX; stdcall; external D3DX10_DLL;


// Build a matrix which reflects the coordinate system about a plane
function D3DXMatrixReflect(pOut: PD3DXMATRIX; pPlane: PD3DXPLANE): PD3DXMATRIX; stdcall; external D3DX10_DLL;
...
procedure D3DXQuaternionToAxisAngle(pQ: PD3DXQUATERNION; pAxis: PD3DXVECTOR3; pAngle: Psingle); stdcall; external D3DX10_DLL;


// Build a quaternion from a rotation matrix.
function D3DXQuaternionRotationMatrix(pOut: PD3DXQUATERNION; pM: PD3DXMATRIX): TD3DXQUATERNION; stdcall; external D3DX10_DLL;


// Rotation about arbitrary axis.
function D3DXQuaternionRotationAxis(pOut: PD3DXQUATERNION; pV: PD3DXVECTOR3; Angle: single): TD3DXQUATERNION; stdcall; external D3DX10_DLL;


// Yaw around the Y axis, a pitch around the X axis,
// and a roll around the Z axis.
function D3DXQuaternionRotationYawPitchRoll(pOut: PD3DXQUATERNION; Yaw: single; Pitch: single; Roll: single): TD3DXQUATERNION; stdcall; external D3DX10_DLL;


// Quaternion multiplication.  The result represents the rotation Q2
// followed by the rotation Q1.  (Out = Q2 * Q1)
function D3DXQuaternionMultiply(pOut: PD3DXQUATERNION; pQ1: PD3DXQUATERNION; pQ2: PD3DXQUATERNION): TD3DXQUATERNION; stdcall; external D3DX10_DLL;


function D3DXQuaternionNormalize(pOut: PD3DXQUATERNION; pQ: PD3DXQUATERNION): TD3DXQUATERNION; stdcall; external D3DX10_DLL;


// Conjugate and re-norm
function D3DXQuaternionInverse(pOut: PD3DXQUATERNION; pQ: PD3DXQUATERNION): TD3DXQUATERNION; stdcall; external D3DX10_DLL;


// Expects unit quaternions.
// if q = (cos(theta), sin(theta) * v); ln(q) = (0, theta * v)
function D3DXQuaternionLn(pOut: PD3DXQUATERNION; pQ: PD3DXQUATERNION): TD3DXQUATERNION; stdcall; external D3DX10_DLL;


// Expects pure quaternions. (w == 0)  w is ignored in calculation.
// if q = (0, theta * v); exp(q) = (cos(theta), sin(theta) * v)
function D3DXQuaternionExp(pOut: PD3DXQUATERNION; pQ: PD3DXQUATERNION): TD3DXQUATERNION; stdcall; external D3DX10_DLL;


// Spherical linear interpolation between Q1 (t == 0) and Q2 (t == 1).
// Expects unit quaternions.
function D3DXQuaternionSlerp(pOut: PD3DXQUATERNION; pQ1: PD3DXQUATERNION; pQ2: PD3DXQUATERNION; t: single): TD3DXQUATERNION; stdcall; external D3DX10_DLL;


// Spherical quadrangle interpolation.
// Slerp(Slerp(Q1, C, t), Slerp(A, B, t), 2t(1-t))
function D3DXQuaternionSquad(pOut: PD3DXQUATERNION; pQ1: PD3DXQUATERNION; pA: PD3DXQUATERNION; pB: PD3DXQUATERNION; pC: PD3DXQUATERNION; t: single): TD3DXQUATERNION; stdcall; external D3DX10_DLL;


// Setup control points for spherical quadrangle interpolation
// from Q1 to Q2.  The control points are chosen in such a way
// to ensure the continuity of tangents with adjacent segments.
procedure D3DXQuaternionSquadSetup(pAOut: PD3DXQUATERNION; pBOut: PD3DXQUATERNION; pCOut: PD3DXQUATERNION; pQ0: PD3DXQUATERNION; pQ1: PD3DXQUATERNION; pQ2: PD3DXQUATERNION; pQ3: PD3DXQUATERNION); stdcall; external D3DX10_DLL;


// Barycentric interpolation.
// Slerp(Slerp(Q1, Q2, f+g), Slerp(Q1, Q3, f+g), g/(f+g))
function D3DXQuaternionBaryCentric(pOut: PD3DXQUATERNION; pQ1: PD3DXQUATERNION; pQ2: PD3DXQUATERNION; pQ3: PD3DXQUATERNION; f: single; g: single): TD3DXQUATERNION; stdcall; external D3DX10_DLL;
...
function D3DXPlaneNormalize(pOut: PD3DXPLANE; pP: PD3DXPLANE): TD3DXPLANE; stdcall; external D3DX10_DLL;


// Find the intersection between a plane and a line.  If the line is
// parallel to the plane, NULL is returned.
function D3DXPlaneIntersectLine(pOut: PD3DXVECTOR3; pP: PD3DXPLANE; pV1: PD3DXVECTOR3; pV2: PD3DXVECTOR3): TD3DXVECTOR3; stdcall; external D3DX10_DLL;


// Construct a plane from a point and a normal
function D3DXPlaneFromPointNormal(pOut: PD3DXPLANE; pPoint: PD3DXVECTOR3; pNormal: PD3DXVECTOR3): TD3DXPLANE; stdcall; external D3DX10_DLL;


// Construct a plane from 3 points
function D3DXPlaneFromPoints(pOut: PD3DXPLANE; pV1: PD3DXVECTOR3; pV2: PD3DXVECTOR3; pV3: PD3DXVECTOR3): TD3DXPLANE; stdcall; external D3DX10_DLL;


// Transform a plane by a matrix.  The vector (a,b,c) must be normal.
// M should be the inverse transpose of the transformation desired.
function D3DXPlaneTransform(pOut: PD3DXPLANE; pP: PD3DXPLANE; pM: PD3DXMATRIX): TD3DXPLANE; stdcall; external D3DX10_DLL;


// Transform an array of planes by a matrix.  The vectors (a,b,c) must be normal.
// M should be the inverse transpose of the transformation desired.
function D3DXPlaneTransformArray(pOut: PD3DXPLANE; OutStride: UINT; pP: PD3DXPLANE; PStride: UINT; pM: PD3DXMATRIX; n: UINT): TD3DXPLANE; stdcall; external D3DX10_DLL;
...
function D3DXColorAdjustSaturation(pOut: PD3DXCOLOR; pC: PD3DXCOLOR; s: single): TD3DXCOLOR; stdcall; external D3DX10_DLL;


// Interpolate r,g,b between 50% grey and color.  Grey + s(Color - Grey)
function D3DXColorAdjustContrast(pOut: PD3DXCOLOR; pC: PD3DXCOLOR; c: single): TD3DXCOLOR; stdcall; external D3DX10_DLL;
...
function D3DXFresnelTerm(CosTheta: single; RefractionIndex: single): single; stdcall; external D3DX10_DLL;


function D3DXCreateMatrixStack(Flags: UINT; out ppStack: ID3DXMATRIXSTACK): HRESULT; stdcall; external D3DX10_DLL;
...
function D3DXSHEvalDirection(pOut: Psingle; Order: UINT; pDir: PD3DXVECTOR3): single; stdcall; external D3DX10_DLL;
...
function D3DXSHRotate(
    {__out_ecount(Order*Order) } pOut: Psingle; Order: UINT; pMatrix: PD3DXMATRIX; pIn: Psingle): single; stdcall; external D3DX10_DLL;
...
function D3DXSHRotateZ(pOut: Psingle; Order: UINT; Angle: single; pIn: Psingle): single; stdcall; external D3DX10_DLL;
...
function D3DXSHAdd(
    {__out_ecount(Order*Order) } pOut: Psingle; Order: UINT; pA: Psingle; pB: Psingle): single; stdcall; external D3DX10_DLL;
...
function D3DXSHScale(
    {__out_ecount(Order*Order) } pOut: Psingle; Order: UINT; pIn: Psingle; Scale: single): single; stdcall; external D3DX10_DLL;
...
function D3DXSHDot(Order: UINT; pA: Psingle; pB: Psingle): single; stdcall; external D3DX10_DLL;
...
function D3DXSHMultiply2(
    {__out_ecount(4)  } pOut: Psingle;
    {__in_ecount(4)}  pF: Psingle;
    {__in_ecount(4)}  pG: Psingle): single; stdcall; external D3DX10_DLL;

function D3DXSHMultiply3(
    {__out_ecount(9)  } pOut: Psingle;
    {__in_ecount(9)}  pF: Psingle;
    {__in_ecount(9)}  pG: Psingle): single; stdcall; external D3DX10_DLL;

function D3DXSHMultiply4(
    {__out_ecount(16) } pOut: Psingle;
    {__in_ecount(16)}  pF: Psingle;
    {__in_ecount(16)}  pG: Psingle): single; stdcall; external D3DX10_DLL;

function D3DXSHMultiply5(
    {__out_ecount(25) } pOut: Psingle;
    {__in_ecount(25)}  pF: Psingle;
    {__in_ecount(25)}  pG: Psingle): single; stdcall; external D3DX10_DLL;

function D3DXSHMultiply6(
    {__out_ecount(36) } pOut: Psingle;
    {__in_ecount(36)}  pF: Psingle;
    {__in_ecount(36)}  pG: Psingle): single; stdcall; external D3DX10_DLL;
...
function D3DXSHEvalDirectionalLight(Order: UINT; pDir: PD3DXVECTOR3; RIntensity: single; GIntensity: single; BIntensity: single;
    {__out_ecount_opt(Order*Order) } pROut: Psingle;
...
function D3DXSHEvalSphericalLight(Order: UINT; pPos: PD3DXVECTOR3; Radius: single; RIntensity: single; GIntensity: single; BIntensity: single;
    {__out_ecount_opt(Order*Order) } pROut: Psingle;
    {__out_ecount_opt(Order*Order) } pGOut: Psingle;
    {__out_ecount_opt(Order*Order) } pBOut: Psingle): HRESULT; stdcall; external D3DX10_DLL;
...
function D3DXSHEvalConeLight(Order: UINT; pDir: PD3DXVECTOR3; Radius: single; RIntensity: single; GIntensity: single; BIntensity: single;
    {__out_ecount_opt(Order*Order) } pROut: Psingle;
    {__out_ecount_opt(Order*Order) } pGOut: Psingle;
    {__out_ecount_opt(Order*Order) } pBOut: Psingle): HRESULT; stdcall; external D3DX10_DLL;
...
function D3DXSHEvalHemisphereLight(Order: UINT; pDir: PD3DXVECTOR3; Top: TD3DXCOLOR; Bottom: TD3DXCOLOR;
    {__out_ecount_opt(Order*Order) } pROut: Psingle;
    {__out_ecount_opt(Order*Order) } pGOut: Psingle;
    {__out_ecount_opt(Order*Order) } pBOut: Psingle): HRESULT; stdcall; external D3DX10_DLL;
...
function D3DXIntersectTri(
    ...
    pU: Psingle;
    // Barycentric Hit Coordinates
    pV: Psingle; pDist: Psingle): boolean; stdcall; external D3DX10_DLL;


function D3DXSphereBoundProbe(pCenter: PD3DXVECTOR3; Radius: single; pRayPosition: PD3DXVECTOR3; pRayDirection: PD3DXVECTOR3): boolean; stdcall; external D3DX10_DLL;


function D3DXBoxBoundProbe(pMin: PD3DXVECTOR3; pMax: PD3DXVECTOR3; pRayPosition: PD3DXVECTOR3; pRayDirection: PD3DXVECTOR3): boolean; stdcall; external D3DX10_DLL;


function D3DXComputeBoundingSphere(
    // pointer to first position
    pFirstPosition: PD3DXVECTOR3; NumVertices: DWORD;
    // count in bytes to subsequent position vectors
    dwStride: DWORD; pCenter: PD3DXVECTOR3; pRadius: Psingle): HRESULT; stdcall; external D3DX10_DLL;
...
function D3DXComputeBoundingBox(
    ...
    pFirstPosition: PD3DXVECTOR3; NumVertices: DWORD;
    // count in bytes to subsequent position vectors
    dwStride: DWORD; pMin: PD3DXVECTOR3; pMax: PD3DXVECTOR3): HRESULT; stdcall; external D3DX10_DLL;
...
function D3DXCpuOptimizations(Enable: boolean): TD3DX_CPU_OPTIMIZATION; stdcall; external D3DX10_DLL;
...
begin
    // At least one is NaN
    if (((a.Value and D3DX_16F_EXP_MASK) = D3DX_16F_EXP_MASK) and ((a.Value and D3DX_16F_FRAC_MASK) = D3DX_16F_FRAC_MASK) or (((b.Value and D3DX_16F_EXP_MASK) = D3DX_16F_EXP_MASK) and
        ((b.Value and D3DX_16F_FRAC_MASK) = D3DX_16F_FRAC_MASK))) then
    begin
        Result := False;
    end
    // +/- Zero
...
var
    mT: TD3DXMATRIX;
begin
    Result:= D3DXMatrixMultiply(@mT, @a, @b)^;
