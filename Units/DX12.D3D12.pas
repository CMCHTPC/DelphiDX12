...
TD3D12_DRED_AUTO_BREADCRUMBS_OUTPUT  = record
                                     pHeadAutoBreadcrumbNode :PD3D12_AUTO_BREADCRUMB_NODE;
    end; PD3D12_DRED_AUTO_BREADCRUMBS_OUTPUT = ^TD3D12_DRED_AUTO_BREADCRUMBS_OUTPUT;

TD3D12_DRED_AUTO_BREADCRUMBS_OUTPUT1  = record
                                      pHeadAutoBreadcrumbNode :PD3D12_AUTO_BREADCRUMB_NODE1;
    end; PD3D12_DRED_AUTO_BREADCRUMBS_OUTPUT1 = ^TD3D12_DRED_AUTO_BREADCRUMBS_OUTPUT1;
...
TD3D12_DRED_PAGE_FAULT_OUTPUT  = record
    ...
    end; PD3D12_DRED_PAGE_FAULT_OUTPUT = ^TD3D12_DRED_PAGE_FAULT_OUTPUT;
...
TD3D12_DRED_PAGE_FAULT_OUTPUT1 = record
    ...
    end; PD3D12_DRED_PAGE_FAULT_OUTPUT1 = ^TD3D12_DRED_PAGE_FAULT_OUTPUT1;
...
TD3D12_DEVICE_REMOVED_EXTENDED_DATA1 = record
    ...
    end; PD3D12_DEVICE_REMOVED_EXTENDED_DATA1 = ^TD3D12_DEVICE_REMOVED_EXTENDED_DATA1;
...
TD3D12_DEVICE_REMOVED_EXTENDED_DATA2 = record
    ...
    end; PD3D12_DEVICE_REMOVED_EXTENDED_DATA2 = ^TD3D12_DEVICE_REMOVED_EXTENDED_DATA2;
    ...
    ['{82BC481C-6B9B-4030-AEDB-7EE3D1DF1E63}']
        procedure  SetAutoBreadcrumbsEnablement(
             Enablement:TD3D12_DRED_ENABLEMENT) ; stdcall;

        procedure  SetPageFaultEnablement(
             Enablement:TD3D12_DRED_ENABLEMENT) ; stdcall;

        procedure  SetWatsonDumpEnablement(
             Enablement:TD3D12_DRED_ENABLEMENT) ; stdcall;
    ...
    ['{DBD5AE51-3317-4F0A-ADF9-1D7CEDCAAE0B}']
        procedure SetBreadcrumbContextEnablement(
             Enablement:TD3D12_DRED_ENABLEMENT); stdcall;
    ...
    ['{98931D33-5AE8-4791-AA3C-1A73A2934E71}']
        function  GetAutoBreadcrumbsOutput(
            out pOutput:TD3D12_DRED_AUTO_BREADCRUMBS_OUTPUT): HResult; stdcall;

        function  GetPageFaultAllocationOutput(
            out   pOutput:TD3D12_DRED_PAGE_FAULT_OUTPUT): HResult; stdcall;
    ...
    ['{9727A022-CF1D-4DDA-9EBA-EFFA653FC506}']
        function  GetAutoBreadcrumbsOutput1(
            out   pOutput:TD3D12_DRED_AUTO_BREADCRUMBS_OUTPUT1): HResult; stdcall;

        function  GetPageFaultAllocationOutput1(
            out   pOutput:TD3D12_DRED_PAGE_FAULT_OUTPUT1) : HResult; stdcall;
...
TD3D12_MEASUREMENTS_ACTION=(
    ...
    ['{c70b221b-40e4-4a17-89af-025a0727a6dc}']
        function  SetBackgroundProcessingMode(
             Mode:TD3D12_BACKGROUND_PROCESSING_MODE;
             MeasurementsAction:TD3D12_MEASUREMENTS_ACTION;
               hEventToSignalUponCompletion:THANDLE;
...
PD3D12_PROTECTED_RESOURCE_SESSION_DESC1 = ^TD3D12_PROTECTED_RESOURCE_SESSION_DESC1;
    ...
    ['{5c014b53-68a1-4b9b-8bd1-dd6046b9358b}']
        function  AddToStateObject(
             const     pAddition:TD3D12_STATE_OBJECT_DESC;
             pStateObjectToGrowFrom:ID3D12StateObject;
            const riid:TGUID;
            out  ppNewStateObject): HResult; stdcall;

        function  CreateProtectedResourceSession1(
            const  pDesc:TD3D12_PROTECTED_RESOURCE_SESSION_DESC1;
             const riid:TGUID;
            out  ppSession) : HResult; stdcall;
    ...
    ['{9218E6BB-F944-4F7E-A75C-B1B2C7B701F3}']
        function GetResourceAllocationInfo2(
             visibleMask:UINT;
        ...
        function  CreateCommittedResource2(
              const  pHeapProperties:TD3D12_HEAP_PROPERTIES;
             HeapFlags:TD3D12_HEAP_FLAGS;
              const  pDesc:TD3D12_RESOURCE_DESC1;
             InitialResourceState:TD3D12_RESOURCE_STATES;
              const  pOptimizedClearValue:TD3D12_CLEAR_VALUE;
        ...
        function  CreatePlacedResource1(
            pHeap:ID3D12Heap;
             HeapOffset:UINT64;
              const  pDesc:TD3D12_RESOURCE_DESC1;
             InitialState:TD3D12_RESOURCE_STATES;
              const  pOptimizedClearValue:TD3D12_CLEAR_VALUE;
            const riid:TGUID;
            out  ppvResource) : HResult; stdcall;
        ...
        procedure  GetCopyableFootprints1(
            const  pResourceDesc:TD3D12_RESOURCE_DESC1;
            FirstSubresource:UINT;
            NumSubresources:UINT;
             BaseOffset:UINT64;
            out pLayouts {NumSubresources}:PD3D12_PLACED_SUBRESOURCE_FOOTPRINT;
            out pNumRows {NumSubresources}: PUINT;
            out pRowSizeInBytes {NumSubresources}: PUINT64;
...
PD3D12_SHADING_RATE_COMBINER = ^TD3D12_SHADING_RATE_COMBINER;
    ...
    ['{55050859-4024-474c-87f5-6472eaee44ea}']
        procedure RSSetShadingRate(
               baseShadingRate:TD3D12_SHADING_RATE;
        ...
        procedure RSSetShadingRateImage(
            shadingRateImage:ID3D12Resource) ; stdcall;
