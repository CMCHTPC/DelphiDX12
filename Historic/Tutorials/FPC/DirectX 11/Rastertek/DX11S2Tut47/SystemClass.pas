...
begin
    ...
    m_hwnd := CreateWindowExW(WS_EX_APPWINDOW, m_applicationName, m_applicationName, WS_CLIPSIBLINGS or
        WS_CLIPCHILDREN or WS_POPUP, posX, posY, screenWidth, screenHeight, 0, 0, m_hinstance, nil);
...
begin
    ...
    if (Result <> S_OK) then
    begin
        MessageBox(m_hwnd, 'Could not initialize the application object.', 'Error', MB_OK);
        Exit;
    end;
