...
type
    ...
    public
        ...
        function Initialize(device: ID3D11Device; deviceContext: ID3D11DeviceContext; screenWidth, screenHeight: integer;
            textureFilename: WideString; bitmapWidth, bitmapHeight: integer): HResult;
        procedure Shutdown();
...
function TBitmapClass.InitializeBuffers(device: ID3D11Device): HResult;
var
...
procedure TBitmapClass.ShutdownBuffers();
begin
...
function TBitmapClass.UpdateBuffers(deviceContext: ID3D11DeviceContext; positionX, positionY: integer): HResult;
var
...
begin
    ...
    if ((positionX = m_previousPosX) and (positionY = m_previousPosY)) then
        Exit;
...
procedure TBitmapClass.RenderBuffers(deviceContext: ID3D11DeviceContext);
var
    stride: uint32;
    offset: uint32;
begin
...
function TBitmapClass.LoadTexture(device: ID3D11Device; deviceContext: ID3D11DeviceContext; filename: WideString): HResult;
begin
...
procedure TBitmapClass.ReleaseTexture();
begin
...
constructor TBitmapClass.Create;
begin
...
destructor TBitmapClass.Destroy;
begin
    inherited Destroy;
end;
...
function TBitmapClass.Initialize(device: ID3D11Device; deviceContext: ID3D11DeviceContext; screenWidth, screenHeight: integer;
    textureFilename: WideString; bitmapWidth, bitmapHeight: integer): HResult;
begin
...
procedure TBitmapClass.Shutdown();
begin
...
function TBitmapClass.Render(deviceContext: ID3D11DeviceContext; positionX, positionY: integer): HResult;
begin
...
function TBitmapClass.GetIndexCount(): integer;
begin
    Result := m_indexCount;
end;
...
function TBitmapClass.GetTexture(): ID3D11ShaderResourceView;
begin
