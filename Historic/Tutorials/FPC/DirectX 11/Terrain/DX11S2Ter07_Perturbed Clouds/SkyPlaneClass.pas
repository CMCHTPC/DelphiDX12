...
type
    ...
    private
        ...
        m_PerturbTexture: TTextureClass;
        m_brightness,m_scale,m_translation: single;
    ...
    public
        ...
        function GetPerturbTexture() : ID3D11ShaderResourceView;
        function GetScale():single;
        function GetBrightness(): single;
        function GetTranslation(index: integer): single;  overload;
        function GetTranslation(): single;   overload;
    end;
...
begin
	...
	m_translation := m_translation + 0.0001;
	if(m_translation > 1.0) then
	begin
...
function TSkyPlaneClass.GetPerturbTexture(): ID3D11ShaderResourceView;
begin
    	result:= m_PerturbTexture.GetTexture();
end;

function TSkyPlaneClass.GetScale(): single;
begin
    result:= m_scale;
end;
...
function TSkyPlaneClass.GetTranslation(): single;
begin
