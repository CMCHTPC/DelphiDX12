...
{$ENDIF}
    ...
    public
        ...
        procedure Shutdown();
        function Frame(Direct3D: TD3DClass; Input: TInputClass; ShaderManager: TShaderManagerClass; frameTime: single; fps: integer): HResult;

    private
        procedure HandleMovementInput(Input: TInputClass; frameTime: single);
        function Render(Direct3D: TD3DClass; ShaderManager: TShaderManagerClass): HResult;
...
{$ENDIF}
    ...
    m_Position.SetPosition(128.0, 5.0, -10.0);
...
function TZoneClass.Frame(Direct3D: TD3DClass; Input: TInputClass; ShaderManager: TShaderManagerClass; frameTime: single; fps: integer): HResult;
var
...
function TZoneClass.Render(Direct3D: TD3DClass; ShaderManager: TShaderManagerClass): HResult;
var
