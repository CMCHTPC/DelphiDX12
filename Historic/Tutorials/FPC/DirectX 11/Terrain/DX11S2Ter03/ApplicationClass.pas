...
begin
    ...
    Result := m_TextureManager.LoadTexture(m_Direct3D.GetDevice(), m_Direct3D.GetDeviceContext(), '.\data\textures\test.tga', 0);
    if (Result <> S_OK) then Exit;


    Result := m_TextureManager.LoadTexture(m_Direct3D.GetDevice(), m_Direct3D.GetDeviceContext(), '.\data\textures\dirt01d.tga', 1);
    if (Result <> S_OK) then Exit;
