...
type
    ...
    public
        ...
        function RenderCell(deviceContext: ID3D11DeviceContext; cellId: integer; Frustum: TFrustumClass): HResult;
...
function TTerrainClass.RenderCell(deviceContext: ID3D11DeviceContext; cellId: integer; Frustum: TFrustumClass): HResult;
var
...
begin
    ...
    begin
        ...
        begin
            ...
            Result := m_TerrainCells[index].Initialize(device, @m_terrainModel[0], i, j, cellHeight, cellWidth, m_terrainWidth);
            if (Result <> S_OK) then Exit;
        end;
    end;
