...
type
    ...
    public
        ...
        function IsLeftArrowPressed(): boolean;
        function IsRightArrowPressed(): boolean;
...
function TInputClass.IsLeftArrowPressed(): boolean;
begin
...
function TInputClass.IsRightArrowPressed(): boolean;
begin
