...
type
    ...
    private
        ...
        function SetShaderParameters(deviceContext: ID3D11DeviceContext; worldMatrix, viewMatrix, projectionMatrix: TXMMATRIX;
            texture: ID3D11ShaderResourceView; lightDirection: TXMFLOAT3; ambientColor: TXMFLOAT4; diffuseColor: TXMFLOAT4;
...
function TLightShaderClass.SetShaderParameters(deviceContext: ID3D11DeviceContext; worldMatrix, viewMatrix, projectionMatrix: TXMMATRIX;
    texture: ID3D11ShaderResourceView; lightDirection: TXMFLOAT3; ambientColor: TXMFLOAT4; diffuseColor: TXMFLOAT4;cameraPosition: TXMFLOAT3; specularColor: TXMFLOAT4; specularPower: single): HResult;
var
...
function TLightShaderClass.Render(deviceContext: ID3D11DeviceContext; indexCount: integer;
    ...
    ambientColor: TXMFLOAT4; diffuseColor: TXMFLOAT4;
            cameraPosition: TXMFLOAT3; specularColor: TXMFLOAT4; specularPower: single): HResult;
begin
