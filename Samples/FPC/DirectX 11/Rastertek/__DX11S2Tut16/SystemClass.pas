...
begin
    ...
    m_hwnd := CreateWindowExW(WS_EX_APPWINDOW, m_applicationName, m_applicationName, WS_CLIPSIBLINGS or WS_CLIPCHILDREN {or WS_POPUP} or WS_CAPTION, posX, posY, screenWidth, screenHeight, 0, 0, m_hinstance, nil);
