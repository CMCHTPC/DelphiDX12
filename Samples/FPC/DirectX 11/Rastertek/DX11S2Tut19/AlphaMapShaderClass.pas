...
type
    ...
    { TAlphaMapShaderClass }

    TAlphaMapShaderClass = class(TObject)
    private
...
function TAlphaMapShaderClass.InitializeShader(device: ID3D11Device; hwnd: HWND; vsFilename, psFilename: WideString): HResult;
var
...
begin
    ...
    Result := D3DCompileFromFile(pwidechar(vsFilename), nil, nil, 'AlphaMapVertexShader', 'vs_5_0',
    ...
    Result := D3DCompileFromFile(pwidechar(psFilename), nil, nil, 'AlphaMapPixelShader', 'ps_5_0', D3D10_SHADER_ENABLE_STRICTNESS,
...
procedure TAlphaMapShaderClass.ShutdownShader();
begin
...
procedure TAlphaMapShaderClass.OutputShaderErrorMessage(errorMessage: ID3D10Blob; hwnd: HWND; shaderFilename: WideString);
var
...
function TAlphaMapShaderClass.SetShaderParameters(deviceContext: ID3D11DeviceContext; worldMatrix, viewMatrix, projectionMatrix: TXMMATRIX;
    textureArray: PID3D11ShaderResourceView): HResult;
var
...
procedure TAlphaMapShaderClass.RenderShader(deviceContext: ID3D11DeviceContext; indexCount: integer);
begin
...
constructor TAlphaMapShaderClass.Create;
begin
...
destructor TAlphaMapShaderClass.Destroy;
begin
    inherited Destroy;
end;
...
function TAlphaMapShaderClass.Initialize(device: ID3D11Device; hwnd: HWND): Hresult;
begin
    // Initialize the vertex and pixel shaders.
    Result := InitializeShader(device, hwnd, '.\data\alphamap.vs', '.\data\alphamap.ps');
end;



procedure TAlphaMapShaderClass.Shutdown();
begin
...
function TAlphaMapShaderClass.Render(deviceContext: ID3D11DeviceContext; indexCount: integer;
