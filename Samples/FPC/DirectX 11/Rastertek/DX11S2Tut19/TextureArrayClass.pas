...
function TTextureArrayClass.Initialize(device: ID3D11Device; deviceContext: ID3D11DeviceContext; filename1: widestring; filename2: widestring; filename3: widestring): HResult;
begin
