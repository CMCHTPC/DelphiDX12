...
type
    ...
    public
        ...
        procedure GetVideoCardInfo(var cardName: PChar; var memory: integer);
    end;
...
begin
    ...
    adapterDesc.Description := utf8Decode(m_videoCardDescription);
    ...
    Result := D3D11CreateDeviceAndSwapChain(nil, D3D_DRIVER_TYPE_HARDWARE, 0, ord(D3D11_CREATE_DEVICE_DEBUG), @featureLevel, 1, D3D11_SDK_VERSION,
...
procedure TD3DClass.GetVideoCardInfo(var cardName: PChar; var memory: integer);
begin
