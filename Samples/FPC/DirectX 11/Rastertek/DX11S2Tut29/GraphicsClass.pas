...
begin
    ...
    Result := m_GroundModel.Initialize(m_Direct3D.GetDevice(), m_Direct3D.GetDeviceContext(), '.\data\ground.txt', '.\data\ground01.dds');
    if (Result <> S_OK) then
    begin
    ...
    Result := m_WallModel.Initialize(m_Direct3D.GetDevice(), m_Direct3D.GetDeviceContext(), '.\data\wall.txt', '.\data\wall01.dds');
    if (Result <> S_OK) then
    begin
    ...
    Result := m_BathModel.Initialize(m_Direct3D.GetDevice(), m_Direct3D.GetDeviceContext(), '.\data\bath.txt', '.\data\marble01.dds');
    if (Result <> S_OK) then
    begin
    ...
    Result := m_WaterModel.Initialize(m_Direct3D.GetDevice(), m_Direct3D.GetDeviceContext(), '.\data\water.txt', '.\data\water01.dds');
    if (Result <> S_OK) then
    begin
