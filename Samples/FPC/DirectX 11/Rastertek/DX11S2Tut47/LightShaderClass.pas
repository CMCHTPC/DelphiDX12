...
type
    ...
    private
        ...
        function SetShaderParameters(deviceContext: ID3D11DeviceContext; worldMatrix, viewMatrix, projectionMatrix: TXMMATRIX;
            texture: ID3D11ShaderResourceView; lightDirection: TXMFLOAT3): HResult;
...
function TLightShaderClass.Render(deviceContext: ID3D11DeviceContext;
