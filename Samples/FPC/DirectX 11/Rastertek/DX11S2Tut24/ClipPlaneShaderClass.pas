...
type
    ...
    { TClipPlaneShaderClass }

    TClipPlaneShaderClass = class(TObject)
    private
    ...
    private
        ...
        function SetShaderParameters(deviceContext: ID3D11DeviceContext; worldMatrix, viewMatrix, projectionMatrix: TXMMATRIX;
            texture: ID3D11ShaderResourceView; clipPlane: TXMFLOAT4): HResult;
...
function TClipPlaneShaderClass.InitializeShader(device: ID3D11Device; hwnd: HWND; vsFilename, psFilename: WideString): HResult;
var
...
begin
    ...
    Result := D3DCompileFromFile(pwidechar(vsFilename), nil, nil, 'ClipPlaneVertexShader', 'vs_5_0',
    ...
    Result := D3DCompileFromFile(pwidechar(psFilename), nil, nil, 'ClipPlanePixelShader', 'ps_5_0',
...
procedure TClipPlaneShaderClass.ShutdownShader();
begin
...
procedure TClipPlaneShaderClass.OutputShaderErrorMessage(errorMessage: ID3D10Blob; hwnd: HWND; shaderFilename: WideString);
var
...
function TClipPlaneShaderClass.SetShaderParameters(deviceContext: ID3D11DeviceContext; worldMatrix, viewMatrix, projectionMatrix: TXMMATRIX;
    texture: ID3D11ShaderResourceView; clipPlane: TXMFLOAT4): HResult;
var
    mappedResource: TD3D11_MAPPED_SUBRESOURCE;
    dataPtr: ^TMatrixBufferType;
    bufferNumber: UINT;
    dataPtr2: ^TClipPlaneBufferType;
begin
...
procedure TClipPlaneShaderClass.RenderShader(deviceContext: ID3D11DeviceContext; indexCount: integer);
begin
...
constructor TClipPlaneShaderClass.Create;
begin
...
destructor TClipPlaneShaderClass.Destroy;
begin
    inherited Destroy;
end;
...
function TClipPlaneShaderClass.Initialize(device: ID3D11Device; hwnd: HWND): Hresult;
begin
    // Initialize the vertex and pixel shaders.
    Result := InitializeShader(device, hwnd, '.\data\clipplane.vs', '.\data\clipplane.ps');
end;



procedure TClipPlaneShaderClass.Shutdown();
begin
...
function TClipPlaneShaderClass.Render(deviceContext: ID3D11DeviceContext; indexCount: integer;
    worldMatrix, viewMatrix, projectionMatrix: TXMMATRIX; texture: ID3D11ShaderResourceView; clipPlane: TXMFLOAT4): HResult;
begin
