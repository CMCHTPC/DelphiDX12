...
type
    ...
    private
        m_textureView: array[0..1] of ID3D11ShaderResourceView;
    public
        constructor Create;
        destructor Destroy; override;

        function Initialize(device: ID3D11Device; deviceContext: ID3D11DeviceContext; filename1: widestring; filename2: widestring): HResult;
        procedure Shutdown();
...
function TTextureArrayClass.Initialize(device: ID3D11Device; deviceContext: ID3D11DeviceContext; filename1: widestring; filename2: widestring): HResult;
begin
