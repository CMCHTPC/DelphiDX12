...
type
    ...
    TBumpMapShaderClass = class(TObject)
    private
    ...
    private
        ...
        function SetShaderParameters(deviceContext: ID3D11DeviceContext; worldMatrix, viewMatrix, projectionMatrix: TXMMATRIX;
            textureArray: PID3D11ShaderResourceView; lightDirection: TXMFLOAT3; diffuseColor: TXMFLOAT4): HResult;
...
function TBumpMapShaderClass.InitializeShader(device: ID3D11Device; hwnd: HWND; vsFilename, psFilename: WideString): HResult;
var
...
begin
    ...
    Result := D3DCompileFromFile(pwidechar(vsFilename), nil, nil, 'BumpMapVertexShader', 'vs_5_0',
    ...
    Result := D3DCompileFromFile(pwidechar(psFilename), nil, nil, 'BumpMapPixelShader', 'ps_5_0', D3D10_SHADER_ENABLE_STRICTNESS,
...
procedure TBumpMapShaderClass.ShutdownShader();
begin
...
procedure TBumpMapShaderClass.OutputShaderErrorMessage(errorMessage: ID3D10Blob; hwnd: HWND; shaderFilename: WideString);
var
...
function TBumpMapShaderClass.SetShaderParameters(deviceContext: ID3D11DeviceContext; worldMatrix, viewMatrix, projectionMatrix: TXMMATRIX;
    textureArray: PID3D11ShaderResourceView; lightDirection: TXMFLOAT3; diffuseColor: TXMFLOAT4): HResult;
var
...
procedure TBumpMapShaderClass.RenderShader(deviceContext: ID3D11DeviceContext; indexCount: integer);
begin
...
constructor TBumpMapShaderClass.Create;
begin
...
destructor TBumpMapShaderClass.Destroy;
begin
    inherited Destroy;
end;
...
function TBumpMapShaderClass.Initialize(device: ID3D11Device; hwnd: HWND): Hresult;
begin
    // Initialize the vertex and pixel shaders.
    Result := InitializeShader(device, hwnd, '.\data\bumpmap.vs', '.\data\bumpmap.ps');
end;



procedure TBumpMapShaderClass.Shutdown();
begin
...
function TBumpMapShaderClass.Render(deviceContext: ID3D11DeviceContext; indexCount: integer;
