...
type
    ...
    public
        ...
        procedure Shutdown();
        function Render(deviceContext: ID3D11DeviceContext; vertexCount,instanceCount: integer; worldMatrix, viewMatrix, projectionMatrix: TXMMATRIX;
            texture: ID3D11ShaderResourceView): HResult;
...
begin
    ...
    Result := D3DCompileFromFile(pwidechar(vsFilename), nil, nil, 'TextureVertexShader', 'vs_5_0', D3D10_SHADER_ENABLE_STRICTNESS,
    ...
    Result := D3DCompileFromFile(pwidechar(psFilename), nil, nil, 'TexturePixelShader', 'ps_5_0', D3D10_SHADER_ENABLE_STRICTNESS,
...
function TTextureShaderClass.SetShaderParameters(deviceContext: ID3D11DeviceContext; worldMatrix, viewMatrix, projectionMatrix: TXMMATRIX;
    texture: ID3D11ShaderResourceView): HResult;
var
...
procedure TTextureShaderClass.RenderShader(deviceContext: ID3D11DeviceContext;
				    vertexCount, instanceCount: integer);
begin
...
function TTextureShaderClass.Render(deviceContext: ID3D11DeviceContext;
				    vertexCount, instanceCount: integer; worldMatrix, viewMatrix,
