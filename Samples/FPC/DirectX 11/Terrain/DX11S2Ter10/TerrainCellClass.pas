...
type
    ...
    private
        function InitializeBuffers(device: ID3D11Device; nodeIndexX, nodeIndexY, cellHeight, cellWidth, terrainWidth: integer; terrainModelPtr: PModelType): HResult;
    ...
    public
        ...
        function Initialize(device: ID3D11Device; terrainModelPtr: PModelType; nodeIndexX, nodeIndexY, cellHeight, cellWidth, terrainWidth: integer): HResult;
        procedure Shutdown();
...
function TTerrainCellClass.InitializeBuffers(device: ID3D11Device; nodeIndexX, nodeIndexY, cellHeight, cellWidth, terrainWidth: integer; terrainModelPtr: PModelType): HResult;
var
...
function TTerrainCellClass.Initialize(device: ID3D11Device; terrainModelPtr: PModelType; nodeIndexX, nodeIndexY, cellHeight, cellWidth, terrainWidth: integer): HResult;
var
    terrainModel: array of TModelType absolute terrainModelPtr;
begin
