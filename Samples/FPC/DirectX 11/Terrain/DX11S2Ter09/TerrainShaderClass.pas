...
type
    ...
    private
        ...
        function SetShaderParameters(deviceContext: ID3D11DeviceContext; worldMatrix, viewMatrix, projectionMatrix: TXMMATRIX;
            texture: ID3D11ShaderResourceView;normalMap:ID3D11ShaderResourceView; lightDirection: TXMFLOAT3;{ ambientColor: TXMFLOAT4;} diffuseColor: TXMFLOAT4): HResult;
...
function TTerrainShaderClass.SetShaderParameters(
				    ...
				    normalMap: ID3D11ShaderResourceView; lightDirection: TXMFLOAT3;
...
begin
    ...
    Result := SetShaderParameters(deviceContext, worldMatrix, viewMatrix, projectionMatrix, texture, normalMap, lightDirection, {ambientColor,} diffuseColor);
