...
type
    ...
    private
        ...
        function SetShaderParameters(deviceContext: ID3D11DeviceContext; worldMatrix, viewMatrix, projectionMatrix: TXMMATRIX;
            texture: ID3D11ShaderResourceView;normalMap,normalMap2,normalMap3:ID3D11ShaderResourceView; lightDirection: TXMFLOAT3;{ ambientColor: TXMFLOAT4;} diffuseColor: TXMFLOAT4): HResult;
...
function TTerrainShaderClass.SetShaderParameters(
				    ...
				    normalMap, normalMap2, normalMap3: ID3D11ShaderResourceView;
...
begin
    ...
    Result := SetShaderParameters(deviceContext, worldMatrix, viewMatrix, projectionMatrix, texture, normalMap,normalMap2,normalMap3, lightDirection, {ambientColor,} diffuseColor);
