...
begin
    ...
    Result := D3DCompileFromFile(pwidechar('.\data\skybox.vs'), nil, nil, 'SkyBoxVertexShader', 'vs_5_0', D3D10_SHADER_ENABLE_STRICTNESS,
        0, vertexShaderBuffer, errorMessage);

    // Compile the pixel shader code.
    Result := D3DCompileFromFile(pwidechar('.\data\skybox.ps'), nil, nil, 'SkyBoxPixelShader', 'ps_5_0', D3D10_SHADER_ENABLE_STRICTNESS,
