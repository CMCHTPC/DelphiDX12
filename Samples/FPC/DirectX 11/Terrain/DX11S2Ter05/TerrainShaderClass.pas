...
var
    ...
    polygonLayout: array [0..3] of TD3D11_INPUT_ELEMENT_DESC;
    numElements: UINT;
...
function TTerrainShaderClass.SetShaderParameters(deviceContext: ID3D11DeviceContext; worldMatrix, viewMatrix, projectionMatrix: TXMMATRIX;
    texture: ID3D11ShaderResourceView; lightDirection: TXMFLOAT3;{ ambientColor: TXMFLOAT4;} diffuseColor: TXMFLOAT4): HResult;
var
