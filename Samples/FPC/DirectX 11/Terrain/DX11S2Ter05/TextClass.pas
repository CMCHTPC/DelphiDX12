...
type
    ...
    public
        ...
        function Initialize(device: ID3D11Device; deviceContext: ID3D11DeviceContext; screenWidth, screenHeight, maxLength: integer; shadow: boolean; Font: TFontClass; Text: ansistring;
            positionX, positionY: integer; red, green, blue: single): HResult;
        procedure Shutdown();
        procedure Render(deviceContext: ID3D11DeviceContext; ShaderManager: TShaderManagerClass; worldMatrix, viewMatrix, orthoMatrix: TXMMATRIX; fontTexture: ID3D11ShaderResourceView);

        function UpdateSentence(deviceContext: ID3D11DeviceContext; Font: TFontClass; Text: ansistring; positionX, positionY: integer; red, green, blue: single): HResult;

    private
        function InitializeSentence(device: ID3D11Device; deviceContext: ID3D11DeviceContext; Font: TFontClass; Text: ansistring; positionX, positionY: integer; red, green, blue: single): HResult;
        procedure RenderSentence(deviceContext: ID3D11DeviceContext; ShaderManager: TShaderManagerClass; worldMatrix, viewMatrix, orthoMatrix: TXMMATRIX; fontTexture: ID3D11ShaderResourceView);
...
function TTextClass.Initialize(device: ID3D11Device; deviceContext: ID3D11DeviceContext; screenWidth, screenHeight, maxLength: integer; shadow: boolean; Font: TFontClass; Text: ansistring;
    positionX, positionY: integer; red, green, blue: single): HResult;
begin
...
procedure TTextClass.Render(deviceContext: ID3D11DeviceContext; ShaderManager: TShaderManagerClass; worldMatrix, viewMatrix, orthoMatrix: TXMMATRIX; fontTexture: ID3D11ShaderResourceView);
begin
    // Draw the sentence.
...
function TTextClass.InitializeSentence(device: ID3D11Device; deviceContext: ID3D11DeviceContext; Font: TFontClass; Text: ansistring; positionX, positionY: integer; red, green, blue: single): HResult;
var
...
function TTextClass.UpdateSentence(deviceContext: ID3D11DeviceContext; Font: TFontClass; Text: ansistring; positionX, positionY: integer; red, green, blue: single): HResult;
var
    numLetters: integer;
    vertices: array of TVertexType;
    drawX, drawY: single;
...
procedure TTextClass.RenderSentence(deviceContext: ID3D11DeviceContext; ShaderManager: TShaderManagerClass; worldMatrix, viewMatrix, orthoMatrix: TXMMATRIX; fontTexture: ID3D11ShaderResourceView);
var
