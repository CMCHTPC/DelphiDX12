...
type
    ...
    TTerrainShaderClass = class(TObject)
    private
    ...
    private
        ...
        function SetShaderParameters(deviceContext: ID3D11DeviceContext; worldMatrix, viewMatrix, projectionMatrix: TXMMATRIX;
            texture: ID3D11ShaderResourceView; normalMap, normalMap2, normalMap3: ID3D11ShaderResourceView;
            lightDirection: TXMFLOAT3;{ ambientColor: TXMFLOAT4;} diffuseColor: TXMFLOAT4): HResult;
    ...
    public
        ...
        function SetShaderParametersExtern(deviceContext: ID3D11DeviceContext; worldMatrix, viewMatrix, projectionMatrix: TXMMATRIX;
            lightDirection: TXMFLOAT3; diffuseColor: TXMFLOAT4): HResult;
        function RenderExtern(deviceContext: ID3D11DeviceContext; indexCount: integer; texture: ID3D11ShaderResourceView;
            normalMap, normalMap2, normalMap3: ID3D11ShaderResourceView): HResult;
    end;
...
function TTerrainShaderClass.InitializeShader(device: ID3D11Device; hwnd: HWND; vsFilename, psFilename: WideString): HResult;
var
...
begin
    ...
    Result := D3DCompileFromFile(pwidechar(vsFilename), nil, nil, 'TerrainVertexShader', 'vs_5_0', D3D10_SHADER_ENABLE_STRICTNESS,
    ...
    Result := D3DCompileFromFile(pwidechar(psFilename), nil, nil, 'TerrainPixelShader', 'ps_5_0', D3D10_SHADER_ENABLE_STRICTNESS,
...
procedure TTerrainShaderClass.ShutdownShader();
begin
...
procedure TTerrainShaderClass.OutputShaderErrorMessage(errorMessage: ID3D10Blob; hwnd: HWND; shaderFilename: WideString);
var
...
function TTerrainShaderClass.SetShaderParameters(deviceContext: ID3D11DeviceContext;
    worldMatrix, viewMatrix, projectionMatrix: TXMMATRIX; texture: ID3D11ShaderResourceView;
    normalMap, normalMap2, normalMap3: ID3D11ShaderResourceView; lightDirection: TXMFLOAT3; diffuseColor: TXMFLOAT4): HResult;
var
...
procedure TTerrainShaderClass.RenderShader(deviceContext: ID3D11DeviceContext; indexCount: integer);
begin
...
constructor TTerrainShaderClass.Create;
begin
...
destructor TTerrainShaderClass.Destroy;
begin
    inherited Destroy;
end;
...
function TTerrainShaderClass.Initialize(device: ID3D11Device; hwnd: HWND): Hresult;
begin
    // Initialize the vertex and pixel shaders.
    Result := InitializeShader(device, hwnd, '.\data\terrain.vs', '.\data\terrain.ps');
end;



procedure TTerrainShaderClass.Shutdown();
begin
...
function TTerrainShaderClass.Render(deviceContext: ID3D11DeviceContext; indexCount: integer;
    worldMatrix, viewMatrix, projectionMatrix: TXMMATRIX; texture: ID3D11ShaderResourceView;
    normalMap, normalMap2, normalMap3: ID3D11ShaderResourceView; lightDirection: TXMFLOAT3; diffuseColor: TXMFLOAT4): HResult;
begin
    // Set the shader parameters that it will use for rendering.
    Result := SetShaderParameters(deviceContext, worldMatrix, viewMatrix, projectionMatrix, texture,
        normalMap, normalMap2, normalMap3, lightDirection, {ambientColor,} diffuseColor);
...
function TTerrainShaderClass.SetShaderParametersExtern(deviceContext: ID3D11DeviceContext;
    worldMatrix, viewMatrix, projectionMatrix: TXMMATRIX; lightDirection: TXMFLOAT3; diffuseColor: TXMFLOAT4): HResult;
var
    mappedResource: TD3D11_MAPPED_SUBRESOURCE;
    dataPtr: ^TMatrixBufferType;
    dataPtr2: ^TLightBufferType;
...
function TTerrainShaderClass.RenderExtern(deviceContext: ID3D11DeviceContext; indexCount: integer;
    texture: ID3D11ShaderResourceView; normalMap, normalMap2, normalMap3: ID3D11ShaderResourceView): HResult;
begin
    // Set shader texture resource in the pixel shader.
    deviceContext.PSSetShaderResources(0, 1, @texture);
    deviceContext.PSSetShaderResources(1, 1, @normalMap);
