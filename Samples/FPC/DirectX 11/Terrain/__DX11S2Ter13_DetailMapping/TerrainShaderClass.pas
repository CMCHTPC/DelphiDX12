...
type
    ...
    private
        ...
        function SetShaderParameters(deviceContext: ID3D11DeviceContext; worldMatrix, viewMatrix, projectionMatrix: TXMMATRIX;
            texture, detailTexture: ID3D11ShaderResourceView; normalMap: ID3D11ShaderResourceView;
    ...
    public
        ...
        function Render(deviceContext: ID3D11DeviceContext; indexCount: integer; worldMatrix, viewMatrix, projectionMatrix: TXMMATRIX;
            texture, detailTexture: ID3D11ShaderResourceView; normalMap: ID3D11ShaderResourceView; lightDirection: TXMFLOAT3;
...
var
    ...
    polygonLayout: array [0..5] of TD3D11_INPUT_ELEMENT_DESC;
    numElements: UINT;
...
function TTerrainShaderClass.SetShaderParameters(deviceContext: ID3D11DeviceContext;
    worldMatrix, viewMatrix, projectionMatrix: TXMMATRIX; texture, detailTexture: ID3D11ShaderResourceView;
    normalMap: ID3D11ShaderResourceView; lightDirection: TXMFLOAT3; diffuseColor: TXMFLOAT4): HResult;
var
...
begin
    ...
    Result := SetShaderParameters(deviceContext, worldMatrix, viewMatrix, projectionMatrix, texture, detailTexture,
        normalMap, lightDirection, {ambientColor,} diffuseColor);
