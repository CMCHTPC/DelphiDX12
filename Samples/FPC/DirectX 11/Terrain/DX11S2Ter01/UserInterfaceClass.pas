...
begin
    ...
    Result := m_Font1.Initialize(Direct3D.GetDevice(), Direct3D.GetDeviceContext(), '.\data\fontdata.txt',
        '.\data\font.dds', 32.0, 3);
