...
type
    ...
    public
        ...
        function RenderTerrainShader(deviceContext: ID3D11DeviceContext; indexCount: integer;
            ...
            normalMap,normalMap2: ID3D11ShaderResourceView; lightDirection: TXMFLOAT3; diffuseColor: TXMFLOAT4): HResult;
...
function TShaderManagerClass.RenderTerrainShader(deviceContext: ID3D11DeviceContext; indexCount: integer;
    worldMatrix, viewMatrix, projectionMatrix: TXMMATRIX; texture: ID3D11ShaderResourceView; normalMap,normalMap2: ID3D11ShaderResourceView;
...
begin
    Result := m_TerrainShader.Render(deviceContext, indexCount, worldMatrix, viewMatrix, projectionMatrix,
        texture, normalMap,normalMap2, lightDirection, diffuseColor);
end;
