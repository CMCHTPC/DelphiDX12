...
{    Result := m_TextureManager.LoadTexture(m_Direct3D.GetDevice(), m_Direct3D.GetDeviceContext(), '.\data\textures\dirt01d.tga', 0);
    ...
    (*
    Result := m_TextureManager.LoadTexture(m_Direct3D.GetDevice(), m_Direct3D.GetDeviceContext(), '.\data\textures\rock01d.tga', 0);
    if (Result <> S_OK) then Exit;

    Result := m_TextureManager.LoadTexture(m_Direct3D.GetDevice(), m_Direct3D.GetDeviceContext(), '.\data\textures\rock01n.tga', 1);
    if (Result <> S_OK) then Exit;

    Result := m_TextureManager.LoadTexture(m_Direct3D.GetDevice(), m_Direct3D.GetDeviceContext(), '.\data\textures\snow01n.tga', 2);
    if (Result <> S_OK) then Exit;

    Result := m_TextureManager.LoadTexture(m_Direct3D.GetDevice(), m_Direct3D.GetDeviceContext(), '.\data\textures\distance01n.tga', 3);
    if (Result <> S_OK) then Exit;
              *)

              Result := m_TextureManager.LoadTexture(m_Direct3D.GetDevice(), m_Direct3D.GetDeviceContext(), '.\data\textures\texture01.dds', 0);
              Result := m_TextureManager.LoadTexture(m_Direct3D.GetDevice(), m_Direct3D.GetDeviceContext(), '.\data\textures\texture02.dds', 1);
              Result := m_TextureManager.LoadTexture(m_Direct3D.GetDevice(), m_Direct3D.GetDeviceContext(), '.\data\textures\texture03.dds', 2);
              Result := m_TextureManager.LoadTexture(m_Direct3D.GetDevice(), m_Direct3D.GetDeviceContext(), '.\data\textures\rock01d.tga', 3);
              Result := m_TextureManager.LoadTexture(m_Direct3D.GetDevice(), m_Direct3D.GetDeviceContext(), '.\data\textures\dirt01d.tga', 4);
              Result := m_TextureManager.LoadTexture(m_Direct3D.GetDevice(), m_Direct3D.GetDeviceContext(), '.\data\textures\snow01d.tga', 5);
              Result := m_TextureManager.LoadTexture(m_Direct3D.GetDevice(), m_Direct3D.GetDeviceContext(), '.\data\textures\alpha04.dds', 6);
              Result := m_TextureManager.LoadTexture(m_Direct3D.GetDevice(), m_Direct3D.GetDeviceContext(), '.\data\textures\dirt01n.tga', 7);
              Result := m_TextureManager.LoadTexture(m_Direct3D.GetDevice(), m_Direct3D.GetDeviceContext(), '.\data\textures\dirt01n.tga', 8);
