...
//        function GetIndexCount(): int32;
        ...
        function RenderCell(deviceContext: ID3D11DeviceContext; cellId: integer): HResult;
...
function TTerrainClass.RenderCell(deviceContext: ID3D11DeviceContext; cellId: integer): HResult;
begin
