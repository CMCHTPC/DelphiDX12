...
function TFoliageShaderClass.InitializeShader(device: ID3D11Device; hwnd: HWND; vsFilename, psFilename: WideString): HResult;
var
...
function TFoliageShaderClass.SetShaderParameters(deviceContext: ID3D11DeviceContext; viewMatrix, projectionMatrix: TXMMATRIX;
    texture: ID3D11ShaderResourceView): HResult;
var
...
function TFoliageShaderClass.Initialize(device: ID3D11Device; hwnd: HWND): HResult;
begin
...
function TFoliageShaderClass.Render(deviceContext: ID3D11DeviceContext; vertexCount, instanceCount: integer;
    viewMatrix, projectionMatrix: TXMMATRIX; texture: ID3D11ShaderResourceView): HResult;
begin
